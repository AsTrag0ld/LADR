...
public class Test {
	...
	public static void main(String args[]) throws OutOfCardsException{
		...
		// le joueur conserve deux cartes
		 	System.out.println("Classe PiocheDestination - M�thode distribuer() // R�ponse : '1' + '0' + '1'");
		...
		// le joueur ne conserve pas de carte
			System.out.println("Classe PiocheDestination - M�thode distribuer() // R�ponse : '0' + '0' + '1' + '1' + '0' + '1'");
		...
		// le joueur conserve trois cartes
			System.out.println("Classe PiocheDestination - M�thode distribuer() // R�ponse : '1' + '1' + '1'");
		...
		//Test 25 : Classe : PiocheWagon - M�thode piocher()
		...
		//Test 26 : Classe PiocheDestination - M�thode distribuer()
		// le joueur conserve deux cartes
		 	System.out.println("Classe PiocheDestination - M�thode piocher() // R�ponse : '1' + '0' + '1'");
		...
		//Test 27 : Classe PiocheDestination - M�thode distribuer()
		// le joueur ne conserve pas de carte
			System.out.println("Classe PiocheDestination - M�thode piocher() // R�ponse : '0' + '0' + '1'");
		...
		//Test 28 : Classe PiocheDestination - M�thode distribuer()
		// le joueur ne conserve pas de carte
			System.out.println("Classe PiocheDestination - M�thode piocher() // R�ponse : '0' + '0' + '0' + '1' + '0' + '0'");
		...
		//Test 29 : Classe PiocheDestination - M�thode distribuer()
		// le joueur conserve trois cartes
			System.out.println("Classe PiocheDestination - M�thode piocher() // R�ponse : '1' + '1' + '1'");
